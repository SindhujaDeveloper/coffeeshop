...
export default function Login() {
  ...
  const { successMessage, errorMessage, userDetails } = useSelector(
    ...
    if (successMessage) {
      dispatch(
        sendSmsRequest({
          ...
          }, This is a test message from spring edge`,
          format: "json",
        })
      );
      navigate("/");
          ...
          <Container fluid>
            <form onSubmit={handleSubmit} className="form_login">
              <Row style={{ paddingLeft: "10%", paddingRight: "10%" }}>
                ...
                {(errors.Mobileno || errorMessage) && (
                  <div id="email">{errorMessage}</div>
                )}
              </Row>
              <Row
                style={{
              ...
              >
                <p className="signupTxt" onClick={() => navigate("/")}>
                  Go To Home Page
                </p>
              </Row>
            </form>
